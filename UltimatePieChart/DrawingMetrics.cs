...
// ***********************************************************************
// <copyright file="DrawingMetrics.cs" company="Zeroit Dev Technologies">
...
namespace Zeroit.Framework.BasicCharts
{
    ...
    #region PieChartControl.DrawingMetrics
    /// <summary>
    ...
    public partial class ZeroitUltimatePieChart : Control
    {
        ...
        internal class DrawingMetrics : IComparable<DrawingMetrics>
        {
            ...
            /// The control
            /// </summary>
            private ZeroitUltimatePieChart control;
            /// <summary>
            /// The item
            /// </summary>
            ...
            public ZeroitUltimatePieChart Control
            {
                get
                {
                    return control;
